...
1. All implementations must also pass through the agent's standard rule checks — this skill enhances visual output, but does not override engineering rules.
